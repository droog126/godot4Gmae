...
#	print('is_step',is_stepping,abs(global_position.distance_to(step_target.global_position)) > step_distance)
#	if !is_stepping  && !adjacent_target.is_stepping  && abs(global_position.distance_to(step_target.global_position)) > step_distance:
	if !is_stepping:
		step()
		var distance = global_position.distance_to(step_target.global_position)
